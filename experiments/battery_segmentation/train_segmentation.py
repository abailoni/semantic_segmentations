...
sys.path += [
os.path.join("/home/abailoni_local/ialgpu1_local_home/pyCharm_projects/segmfriends"),
os.path.join("/home_sdb/abailoni_tmp/local_copy_home/pyCharm_projects/segmfriends")
]
from segmfriends.utils.path_hacks import change_paths_config_file, get_abailoni_hci_home_path
